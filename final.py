...
pd.read_sql("SELECT country, shortName, name, activityType, ecContribution, organizationURL FROM Participants WHERE role = 'coordinator' AND Country='France'",conn)
