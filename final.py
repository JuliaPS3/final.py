...
pd.read_sql("SELECT country, shortName, name, activityType, ecContribution, organizationURL FROM participants WHERE country=={country_chosen}".format(country_chosen=my_acronym),conn)
