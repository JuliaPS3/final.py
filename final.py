...
c1=pd.read_sql("SELECT country, shortName, name, activityType, ecContribution, organizationURL FROM participants WHERE role == 'coordinator' AND country=={}".format(my_acronym))
