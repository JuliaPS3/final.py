...
together=pd.read_sql("SELECT country, shortName, name, activityType, ecContribution, organizationURL FROM Participants LEFT JOIN countries ON Participants.country=countries.Acronym)
