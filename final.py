...
pd.read_sql("SELECT country, shortName, name, activityType, ecContribution, organizationURL FROM Participnats WHERE role = 'coordinator' AND Country='France'",conn)
